...
function show_history(cookie_name) {
  ...
  if (history_data.length > 0) {
    for (var $i = 0; $i < history_data.length; $i++) {
      ...
      historyclean_html = '<li class="drop-item-op"><a href="" class="historyclean">Xoá</a></li>>';
    }
  } else {
    history_html = '<li class="drop-item drop-item-content nolist"><div class="drop-prompt">Không có lịch sử xem phim!</div></li>';
  }
